...
export default function Categories({categories}: Props) {
  const [tableData, setTableData] = useState<Category[]>(categories.data);
  ...
  // Filter + search
  const filteredCategories = tableData.filter((cat) => {
                  ...
                  <td className="px-4 py-2 border flex flex-wrap gap-2 justify-center">
                    ...
                    onClick={() => {
                      if (confirm('Delete this Category?')) {
                        destroy(route('categories.destroy', cat.id), {
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full h-10 border border-gray-300 rounded p-1"
                    />
